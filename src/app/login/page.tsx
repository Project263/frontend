  ...
  return (
    <>
      <div className="min-h-screen bg-gray-100 text-gray-900 flex justify-center">
        <div className="max-w-screen-xl m-0 sm:m-50 bg-white shadow sm:rounded-lg flex justify-center flex-1">
          <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
              ...
              <div className="w-full flex-1 mt-8">
                <div className="mx-auto max-w-xs">
                  ...
                  <input
                    ...
                    placeholder="Пароль"
                  />
                  <button className="mt-5 tracking-wide cursor-pointer font-semibold bg-orange-500 text-gray-100 w-full py-2 rounded-lg hover:bg-orange-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
                    <span>Войти</span>
                  </button>
                </div>
              </div>
            ...
            <div className="flex flex-col items-center justify-center">
              <a
                href="https://sso.theaesthetics.ru/auth/google"
              ...
              >
                ...
                <span className="ml-4">Войти через Google</span>
              </a>
            </div>
          </div>
